...
- `packaging/linux/debian.dockerfile` — Debian 13 `.deb` (`--target package`)
...
Tested on Arch Linux only. Debian, AppImage and Windows builds are best-effort.
